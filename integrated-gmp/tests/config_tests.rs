...
use integrated_gmp::config::{ChainConfig, Config, EvmChainConfig, SvmChainConfig};
use integrated_gmp::monitor::ChainType;
use integrated_gmp::validator::{get_chain_type_from_chain_id, normalize_address};
#[path = "mod.rs"]
mod test_helpers;
...
fn test_connected_chain_mvm_with_values() {
    use integrated_gmp::config::ChainConfig;
