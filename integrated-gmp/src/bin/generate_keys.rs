...
//!
//! # Copy the output to your config/integrated-gmp.toml file
//! ```
//!
//! ## Output
//!
...
//!
//! Copy these values to the `[integrated_gmp]` section of your `config/integrated-gmp.toml` file.
...
fn main() {
    ...
    println!();
    println!("Copy these keys to your config/integrated-gmp.toml file.");
    println!("Add the Move Address as an authorized relay for integrated GMP.");
}
