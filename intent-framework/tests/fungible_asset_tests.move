#[test_only]
module aptos_intent::fungible_asset_tests {
    use std::signer;
    use aptos_framework::timestamp;
    use aptos_framework::fungible_asset;
    use aptos_framework::object;
    use aptos_framework::primary_fungible_store;
    use aptos_intent::fungible_asset_intent;
    ...
    fun test_fa_limit_order(
        ...
        fungible_asset_intent::finish_fa_receiving_session(session, desired_fa);
    ...
    fun test_fa_limit_order_cross_match(
        ...
        let intent1 = fungible_asset_intent::create_fa_to_fa_intent(
        ...
        let intent2 = fungible_asset_intent::create_fa_to_fa_intent(
        ...
        let (solver_fa1, session1) = fungible_asset_intent::start_fa_offering_session(intent1);
        primary_fungible_store::deposit(signer::address_of(solver), solver_fa1);

        let (solver_fa2, session2) = fungible_asset_intent::start_fa_offering_session(intent2);
        ...
        fungible_asset_intent::finish_fa_receiving_session(session1, payment_fa2);
        ...
        fungible_asset_intent::finish_fa_receiving_session(session2, payment_fa1);
    ...
    fun test_revoke_fa_intent(
        ...
        // Revoke the intent
        fungible_asset_intent::revoke_fa_intent(offerer, intent);
