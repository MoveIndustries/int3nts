...
async function main() {
  ...
  await gmpEndpoint.deploymentTransaction().wait(2);
  ...
  await escrowGmp.deploymentTransaction().wait(2);
  ...
  await outflowValidator.deploymentTransaction().wait(2);
