...
module mvmt_intent::intent_tests {
    ...
    // Verifies that starting and finishing an intent session with a valid witness succeeds.
    ...
    // Verifies that starting an intent session after expiry aborts with EINTENT_EXPIRED.
