...
This document tracks test alignment status for VM intent framework contracts (EVM/SVM). For the complete overview and other frameworks, see [Framework Extension Completeness Lists](../docs/intent-frameworks/framework-extension-completeness-lists.md).
