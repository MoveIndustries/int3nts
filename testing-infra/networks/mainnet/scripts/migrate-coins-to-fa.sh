...
# Migrate CoinStore balances to Fungible Asset (FA) stores on Movement Mainnet
#
...
#
# Usage:
#   nix develop ./nix -c bash -c "./testing-infra/networks/mainnet/scripts/migrate-coins-to-fa.sh"
