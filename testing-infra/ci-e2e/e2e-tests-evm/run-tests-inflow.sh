...
log_and_echo ""
log_and_echo " INFLOW test against EVM instance 1 (chain ID $EVM_CHAIN_ID)"
log_and_echo "========================================================================="
...
log_and_echo ""
log_and_echo " Pre-Escrow Balance Validation (instance 1)"
log_and_echo "=========================================="
...
log_and_echo ""
log_and_echo " Final Balance Validation (instance 1)"
log_and_echo "=========================================="
# Post: solver_hub=1015000, requester_hub=2985000, solver_evm1=3000000, requester_evm1=1000000
./testing-infra/ci-e2e/e2e-tests-evm/balance-check.sh 1015000 2985000 3000000 1000000

log_and_echo "✅ INFLOW test passed for EVM instance 1"
...
# solver_hub=1015000, requester_hub=2985000, solver_evm2=2000000, requester_evm2=2000000
...
log_and_echo "=========================================="
# Post: solver_hub=30000, requester_hub=3970000, solver_evm2=3000000, requester_evm2=1000000
