...
svm_cmd "solana-test-validator --reset --ledger \"$SVM_LEDGER_DIR\" --rpc-port $SVM_PORT --faucet-port $SVM_FAUCET_PORT --dynamic-port-range $SVM_DYNAMIC_PORT_RANGE" > "$LOG_FILE" 2>&1 &
VALIDATOR_PID=$!
