...
log "   Desired amount: $DESIRED_AMOUNT (1 token on connected SVM)"
...
log "       Offered metadata (hub chain 1):    $OFFERED_METADATA_CHAIN1"
...
DRAFT_DATA=$(build_draft_data \
    ...
    "{\"chain_addr\": \"$CHAIN1_ADDRESS\", \"flow_type\": \"outflow\", \"connected_chain_type\": \"svm\", \"requester_addr_connected_chain\": \"$REQUESTER_CHAIN2_ADDRESS\"}")
...
log "     Offered metadata (hub chain): $OFFERED_METADATA_CHAIN1"
